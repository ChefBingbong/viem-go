...
description: Encode and decode data according to the Ethereum ABI specification
---
...
fmt.Println("Topic:", transferEvent.Topic.Hex())`
    },
    {
      title: "viem",
      language: "ts",
      code: `import { parseAbi, parseAbiItem } from 'viem'
...
results, err := client.DecodeFunctionResult(client.DecodeFunctionResultOptions{
    ...
    },
    {
      title: "viem",
      language: "ts",
      code: `import { decodeFunctionResult } from 'viem'
