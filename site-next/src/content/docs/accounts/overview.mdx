---
title: Accounts
description: Handle key management and signing operations in viem-go
---
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `account, err := accounts.MnemonicToAccount(
...
account, err := accounts.HDKeyToAccount(hdKey)`
    },
    {
      title: "viem",
      language: "ts",
      code: `import { hdKeyToAccount } from 'viem/accounts'
