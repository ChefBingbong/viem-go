  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `wei := big.NewInt(1500000000000000000)
...
// 20000000000`
    },
    {
      title: "viem",
      language: "ts",
      code: `import { parseGwei } from 'viem'
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `wei := big.NewInt(20000000000)
...
// "20"`
    },
    {
      title: "viem",
      language: "ts",
      code: `import { formatGwei } from 'viem'
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `// Parse USDC amount (6 decimals)
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `// Format USDC amount (6 decimals)
