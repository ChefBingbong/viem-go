  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `import "github.com/ChefBingbong/viem-go/utils/address"
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `checksummed, err := address.GetAddress("0xd8da6bf26964af9d7eed9e03e53415d37aa96045")
if err != nil {
    log.Fatal(err)
}
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `equal := address.IsAddressEqual(
    "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045",
    "0xD8DA6BF26964AF9D7EED9E03E53415D37AA96045",
)
fmt.Println(equal) // true`
    },
    {
      title: "viem",
      language: "ts",
      code: `import { isAddressEqual } from 'viem'
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `contractAddr := address.GetContractAddress(address.GetContractAddressOptions{
...
fmt.Println(contractAddr.Hex())`
    },
    {
      title: "viem",
      language: "ts",
      code: `import { getContractAddress } from 'viem'
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `contractAddr := address.GetCreate2Address(address.GetCreate2AddressOptions{
    From: factoryAddress,
    Salt: salt,        // [32]byte
    ...
    },
    {
      title: "viem",
      language: "ts",
      code: `import { getCreate2Address } from 'viem'
