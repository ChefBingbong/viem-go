  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `selector := hash.ToFunctionSelector("transfer(address,uint256)")
fmt.Printf("0x%x\\n", selector)
// 0xa9059cbb`
    },
    {
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `topic := hash.ToEventSelector("Transfer(address,address,uint256)")
fmt.Printf("%s\\n", topic.Hex())
  ...
  tabs={[
    {
      title: "Go",
      language: "go",
      code: `valid := hash.IsHash("0x1c8aff950685c2ed4bc3174f3472287b56d9517b9c948127319a09a7a36deac8")
